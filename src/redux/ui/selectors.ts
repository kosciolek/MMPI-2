...
export const getAnswersPerPage = (state: RootState) => state.ui.answerView.answersPerPage;
...
export const getAnswerCompactView = (state: RootState) => state.ui.answerView.compactView;
